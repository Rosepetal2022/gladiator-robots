...
var fightOrSkip = function() {
   ...
   // convert promptFight to all lowercae so we check with less options
   promptFight = promptFight.toLowerCase();
   
   if (promptFight === 'skip') {
      //confirm player wants a skip
...
var startGame = function() {
   ...
   // fight each enemy robot by looping over them one at a time
   ...
   // after loop ends, we are either out of player.healt or enemies to fight, so run the endGame function
   endGame();
};
...
var endGame = function() {
   ...
   if (playerInfo.money > highScore) {
      ...
      alert(playerInfo.names + ' did not beat the high score of ' + highScore + '. Maybe next time!');
      }
...
var shop = function() {
   ...
   var shopOptionPrompt = window.prompt(
      'Would you like to REFILL your health, UPGRADE your attack, or LEAVE store? Please enter one "REFILL", "UPGRADE", or "LEAVE GAME" to make a choice.'
   );
